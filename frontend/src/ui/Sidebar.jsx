  ...
  const Section = ({ title, icon, id, children }) => {
    ...
    return (
      <div className="my-1">
        ...
        {expanded && <ul className="pl-6">{children}</ul>}
      </div>
    );
  };
      ...
      <div className="flex flex-col h-full overflow-y-auto">
        ...
        <nav className="mt-10 px-2">
          <ul>
            ...
            {/* Show role-based links when logged in */}
            {user && (
              <>
                ...
                {isStudent && (
                  <Section title="OD Requests" icon={<TbFilePlus />} id="od">
                    <LinkItem
                      to="/student/od-request"
                      icon={<TbFilePlus />}
                      label="OD Request Form"
                    />
                    <LinkItem
                ...
                {isFaculty && (
                  <>
                    ...
                    <Section title="OD Requests" icon={<TbFilePlus />} id="od">
                      ...
                      />
                      <LinkItem
                        to="/faculty/od-requests"
                        icon={<TbHistory />}
                        label="Faculty OD Requests"
                      />
                      <LinkItem
                        to="/OD"
                        icon={<TbHistory />}
                ...
                {/* HOD Links */}
                {isHod && (
                  <Section title="HOD Tools" icon={<TbHome />} id="hod">
                    <LinkItem
                      to="/hod/dashboard"
                      icon={<TbHome />}
                      label="HOD Dashboard"
